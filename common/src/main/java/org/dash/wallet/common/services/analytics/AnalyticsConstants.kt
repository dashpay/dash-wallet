...
object AnalyticsConstants {
    ...
    object ExploreDash {
        ...
        const val FILTER_SELECT_DASH = "explore_filter_select_dash"
        const val FILTER_SELECT_GIFT_CARD = "explore_filter_select_gift_card"
        const val FILTER_SORT_BY_NAME = "explore_filter_sort_by_name"
        const val FILTER_SORT_BY_DISTANCE = "explore_filter_sort_by_distance"
        const val FILTER_CURRENT_LOCATION = "explore_filter_current_location"
        const val FILTER_SELECTED_LOCATION = "explore_filter_selected_location"
        const val FILTER_ONE_MILE = "explore_filter_one_mile"
        const val FILTER_FIVE_MILE = "explore_filter_five_miles"
        const val FILTER_TWENTY_MILE = "explore_filter_twenty_miles"
        const val FILTER_FIFTY_MILE = "explore_filter_fifty_miles"
        const val FILTER_LOCATION_ALLOWED = "explore_filter_location_allowed"
        const val FILTER_LOCATION_DENIED = "explore_filter_location_denied"
        const val FILTER_APPLY_ACTION = "explore_filter_apply_action"
        const val FILTER_CANCEL_ACTION = "explore_filter_cancel_action"
        const val FILTER_SWIPE_DOWN_ACTION_ON = "explore_filter_swipe_down_on"
        const val FILTER_SWIPE_DOWN_ACTION_OFF = "explore_filter_swipe_down_off"
    }
}