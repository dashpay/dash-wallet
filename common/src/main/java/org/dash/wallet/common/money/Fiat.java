 ...
 * safety. Volatile fiat values should not be blindly added to Dash values, be stored in wallets, etc.
 *
 * <p>Self-contained port of {@code org.bitcoinj.utils.Fiat} (dashj 22.0.3, which uses a smallest-unit
 * exponent of 8 unlike upstream bitcoinj's 4) so that modules depending on {@code common} need no
 * dashj on their classpath. Behavior is identical.</p>
 */
public final class Fiat implements Monetary, Comparable<Fiat>, Serializable {

    /**
     * The absolute value of exponent of the value of a "smallest unit" in scientific notation. We picked 8 rather than
     * 4 (as in upstream bitcoinj), because Dash amounts can be converted from tiny fractions of a fiat unit.
     */
     ...
     *             if you try to specify more than the smallest-unit precision, or a value out of range.
     */
    ...
    /**
     * Parses an amount expressed in the way humans are used to. The amount is cut to the smallest-unit precision.
     *
     * <p>This takes string in a format understood by {@link BigDecimal#BigDecimal(String)}, for example "0", "1", "0.10",
     * "1.23E3", "1234.5E-5".</p>
     *
    ...
    /**
     * Returns the number of "smallest units" of this monetary value. It's deprecated in favour of accessing
     * {@link #value} directly.
     */
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.FIAT.minDecimals(0)
     ...
     * instance, an amount of 0.15 would be represented as "0.15".
     * </p>
     */
    ...
    @Override
    public int hashCode() {
        // Matches dashj 22.0.3: Objects.hash(value, currencyCode).
        return java.util.Objects.hash(this.value, this.currencyCode);
    }
