...
class GetUsernameVotingResultOperationTest {
    ...
    companion object {
        ...
        private val MOCK_VOTING_PERIOD_MILLIS = TimeUnit.MINUTES.toMillis(90)
    ...
    fun `delay calculation when voting just started`() {
        ...
        val expectedDelay = MOCK_VOTING_PERIOD_MILLIS + BUFFER_MINUTES
    ...
    fun `scheduled execution time should be voting end time plus buffer`() {
        ...
        val votingEndTime = votingStartedAt + MOCK_VOTING_PERIOD_MILLIS
