...
class ContactRequestViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
    ...
    fun bind(usernameSearchResult: UsernameSearchResult, isNew: Boolean,
             onContactRequestButtonClickListener: OnContactRequestButtonClickListener) {
