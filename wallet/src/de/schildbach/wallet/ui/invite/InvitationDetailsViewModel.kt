...
open class InvitationDetailsViewModel(application: Application) : BaseProfileViewModel(application) {

    private val log = LoggerFactory.getLogger(InvitationDetailsViewModel::class.java)
