...
public class TransactionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int VIEW_TYPE_BUY_WIZARD = 2;
    ...
    public int getItemViewType(final int position) {
        ...
        else if (position <= 1 && isBuyWizard)
            return VIEW_TYPE_BUY_WIZARD;
        else
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        ...
        } else if (viewType == VIEW_TYPE_BUY_WIZARD) {
            return new BuyWizardViewHolder(inflater.inflate(R.layout.transaction_row_warning, parent, false));
        } else {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        } else if (holder instanceof BuyWizardViewHolder) {
            final BuyWizardViewHolder buyWizardViewHolder = (BuyWizardViewHolder) holder;

            Drawable drawable;
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                drawable = context.getResources().getDrawable(R.drawable.ic_menu_sell_dash, context.getTheme());
            } else {
                drawable = context.getResources().getDrawable(R.drawable.ic_menu_sell_dash);
            }

            drawable = DrawableCompat.wrap(drawable);
            DrawableCompat.setTint(drawable.mutate(), context.getResources().getColor(R.color.woc_yellow));

            buyWizardViewHolder.messageView.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null, null);
            buyWizardViewHolder.messageView.setText(Html.fromHtml(context.getString(R.string.wallet_disclaimer_fragment_buy_wizard)));
        }
    }
    ...
    private class BuyWizardViewHolder extends RecyclerView.ViewHolder {
        private final TextView messageView;

        private BuyWizardViewHolder(final View itemView) {
            super(itemView);
            ...
            if (onClickListener != null) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(final View v) {
                        onClickListener.onBuyWizardClick();
                    }
                });
            }
        }
