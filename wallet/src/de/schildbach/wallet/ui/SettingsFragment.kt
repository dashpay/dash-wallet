...
class SettingsFragment : Fragment(R.layout.fragment_settings) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.batteryOptimization.setOnClickListener {
            val walletApplication = requireActivity().application as de.schildbach.wallet.WalletApplication
    ...
    private fun setSelectedCurrency(code: String) {
        lifecycleScope.launch {
            ...
            val walletApplication = requireActivity().application as de.schildbach.wallet.WalletApplication
            val balance = walletApplication.wallet!!.getBalance(org.bitcoinj.wallet.Wallet.BalanceType.ESTIMATED)
