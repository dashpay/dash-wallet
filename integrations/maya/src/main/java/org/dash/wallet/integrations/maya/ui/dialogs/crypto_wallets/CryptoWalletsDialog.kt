 ...
 */
package org.dash.wallet.integrations.maya.ui.dialogs.crypto_wallets
...
class CryptoWalletsDialog(
    ...
    fun submitList(accounts: List<AccountDataUIModel>) {
        viewModel.submitList(accounts)
    }

    private fun refreshItems(rate: ExchangeRate?, dataList: List<AccountDataUIModel>) {
    ...
    private fun setLocalFaitAmount(
        ...
        coinBaseUserAccountData: AccountDataUIModel
    ): Pair<String, Coin>? {
