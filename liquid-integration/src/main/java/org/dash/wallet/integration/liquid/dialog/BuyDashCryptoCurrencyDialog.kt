...
class BuyDashCryptoCurrencyDialog(val contexts: Context, val lifecycle: Lifecycle, val currencyArrayList: List<PayloadItem>, val listener: ValueSelectListener) : BaseBottomSheetDialog(contexts,lifecycle) {
