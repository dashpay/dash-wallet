...
class SelectBuyDashDialog(val contexts: Context, val lifecycle: Lifecycle, private val listener: ValueSelectListener) : BaseBottomSheetDialog(contexts, lifecycle) {
