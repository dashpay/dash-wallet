...
class DashDirectDataSource @Inject constructor(private val config: DashDirectConfig) {
    companion object {
        private val log = LoggerFactory.getLogger(DashDirectDataSource::class.java)
    }
