...
class ExploreViewModelTest {
    ...
    fun filterByTerritoryIsCorrect() {
        runBlocking {
            ...
            val viewModel = ExploreViewModel(context, dataSource, locationState, dataSyncStatus, analyticsService, networkDataProviderMock)
    ...
    fun filterByGeoBoundsIsCorrect() {
        runBlocking {
            ...
            val viewModel = ExploreViewModel(context, dataSource, locationMock, dataSyncStatus, analyticsService, networkDataProviderMock)
